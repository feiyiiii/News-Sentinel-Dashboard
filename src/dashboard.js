...
<head>
  ...
  <title>News Sentinel Dashboard</title>
  <style>
    :root {
      --bg: #f6efe5;
      --panel: #fffaf2;
...
<body>
  <main class="wrap">
    <section class="hero">
      <h1>News Sentinel Dashboard</h1>
      <p>A local dashboard for war updates, tech news, crypto, and metals monitoring.</p>
      <p>Generated at ${escapeHtml(generatedAt)}</p>
      <span class="pill">6-hour monitoring bot</span>
      <span class="pill">Local dashboard</span>
      <span class="pill">Click links to open sources</span>
    </section>
    ...
    <div class="footer">
      File generated locally by News Sentinel Bot.
    </div>
  </main>
</body>
</html>`;
